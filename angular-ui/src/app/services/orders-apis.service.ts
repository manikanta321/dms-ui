...
export class OrdersApisService {
  ...
  public getorderNonPromotionslist(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetOrderNonPromoList',
      data
    );
  }
  ...
  public GetShipingAddress(customerId: any) {
    return this.http.get<any>(
      this.userurl + `OrdersApi/GetShipingAddress?Customerid=${customerId}`
    );
  }
  public GetBillingAddress(customerId: any) {
    return this.http.get<any>(
      this.userurl + `OrdersApi/GetBillingAddress?Customerid=${customerId}`
    );
  }

  public GetGeoGrapydropdownList(customerId: any) {
    return this.http.get<any>(
      this.userurl + `OrdersApi/GetordergeoDropdown?Customerid=${customerId}`
    );
  }
  public addorderNonPromotionsdata(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetStockFullDeatils',
      data
    );
  }
  public addorderPromotionsdata(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetStockFullDeatilsForPromo',
      data
    );
  }
  ...
  public GetOrdersToEdit(CustomerPoId: any) {
    return this.http.get<any>(
      this.userurl + `OrdersApi/GetOrdersToEdit?OrderId=${CustomerPoId}`
    );
  }

  public GetConfirmOrder(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/OrderConfirmReject',
      data
    );
  }
  ...
  public getShipmentList(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetAllShipments',
      data
    );
  }
  public getOrderReceiptList(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetOrderReceiptList',
      data
    );
  }
  ...
  public getDownloadShipmentList(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetShipUploadList',
      data
    );
  }
  public orderpromotionimages(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetPromotionListForOrder',
      data
    );
  }
  public GetProductsOfPromotionForOrder(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetProductsOfPromotionForOrder',
      data
    );
  }
  ...
  public getShippingandPackingcharges(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetShippingAndPackingCharges',
      data
    );
  }
  ...
  public shipOrder(data) {
    return this.http.get<any>(
      this.userurl + `OrdersApi/GetOrderByship?orderId=${data}`
    );
  }

  public reciveshipment(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetOrderByshipReceive',
      data
    );
  }
  ...
  public saveReciveShipment(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/AddReceiveShipOrder',
      data
    );
  }
  ...
  public calculateTotal(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetShippingAndPackingChargesforship',
      data
    );
  }
  ...
  public dealersDetails(data) {
    return this.http.get<any>(
      this.userurl + `CommonApi/GetDealerId?CurrentUserId=${data}`
    );
  }

  getStatusDrodownData(data) {
    return this.http.post<any>(
      this.userurl + 'OrdersApi/GetAllStatusdrop',
      data
    );
  }
  deleteshipment(data) {
  ...
  GetProductNameCode() {
    return this.http.get<any>(
      this.userurl + 'OrdersApi/GetProductAndCodeDropdown'
    );
  }
  closeOrder(data){
